        ...
        return (
            <>
                <div className="contact-container">
                    ...
                    <div className="each-contact"><a href="https://drive.google.com/file/d/1adI01THd55IVlqbxiNmRV--xMshGa4Eq/view" target="_blank" title="resume" className="resume" >Resume</a></div>
                </div>
